...
namespace RunayAI
{
    public class RunaySettings : ModSettings
    {
    ...
    {
        public static RunaySettings settings;
        ...
        public override void DoSettingsWindowContents(Rect inRect)
        {
            ...
            listingStandard.TextFieldNumericLabeled<int>($"Pawn/Turret LOS (additive on intersect) (def: {RunaySettings.AVOID_DEFAULT_COST})", ref settings.costLOS, ref settings.costLOSBuf);
            listingStandard.End();
            settings.Write();
        }
        ...
        {
            return "THEYAREKNOWYOURKILLZONE";
        }
    }
}
